...
IFTTTWebhook::IFTTTWebhook(const char* api_key) : IFTTTWebhook::IFTTTWebhook(api_key, DEFAULT_IFTTT_FINGERPRINT) {
}

IFTTTWebhook::IFTTTWebhook(const char* api_key, const char* ifttt_fingerprint) {
  _api_key = api_key;
  _ifttt_fingerprint = ifttt_fingerprint;
}

int IFTTTWebhook::trigger(const char * _event_name) {
  return IFTTTWebhook::trigger(_event_name,NULL, NULL, NULL);
}

int IFTTTWebhook::trigger(const char * _event_name,const char* value1) {
  return IFTTTWebhook::trigger(_event_name,value1, NULL, NULL);
}

int IFTTTWebhook::trigger(const char * _event_name,const char* value1, const char* value2) {
  return IFTTTWebhook::trigger(_event_name,value1, value2, NULL);
}
...
int IFTTTWebhook::trigger(const char * _event_name,const char* value1, const char* value2, const char* value3) {
  HTTPClient http;
